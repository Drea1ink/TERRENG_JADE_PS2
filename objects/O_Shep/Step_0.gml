		...
		if(clipping == false){	/// @DnDAction : YoYo Games.Common.If_Variable
			...
			if(dir == 0){	/// @DnDAction : YoYo Games.Common.If_Variable
				...
				/// @DnDParent : 1A877533
					...
					/// @DnDParent : 1782A63C
					/// @DnDArgument : "imageind_relative" "1"
					/// @DnDArgument : "spriteind" "S_Wind"
					/// @DnDSaveInfo : "spriteind" "S_Wind"
					sprite_index = S_Wind;
					image_index += 0;}}
			...
			/// @DnDParent : 507C5DF6
				...
				/// @DnDParent : 5D413DDA
					...
					/// @DnDParent : 778531A7
					/// @DnDArgument : "imageind_relative" "1"
					/// @DnDArgument : "spriteind" "S_Wind_left"
					/// @DnDSaveInfo : "spriteind" "S_Wind_left"
					sprite_index = S_Wind_left;
					image_index += 0;}}}}}
...
if(hp <= 0){	/// @DnDAction : YoYo Games.Common.If_Variable
	...
	/// @DnDParent : 78688618
		...
		/// @DnDHash : 7ED38C0F
		/// @DnDParent : 51CFE14C
		/// @DnDArgument : "room" "Game_over2"
		/// @DnDSaveInfo : "room" "Game_over2"
